    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.SmallIntegerField(validators=[django.core.validators.MinValueValidator(-5), django.core.validators.MaxValueValidator(10)])),
            ],
        ),
        migrations.CreateModel(
            name='Specialty',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_ward', models.CharField(choices=[('Vip', 'Vip'), ('Simple', 'Simple'), ('Medium', 'Medium')], max_length=60)),
                ('totel_people', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(20)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_day', multiselectfield.db.fields.MultiSelectField(choices=[('ПН', 'ПН'), ('ВТ', 'ВТ'), ('СР', 'СР'), ('ЧТ', 'ЧТ'), ('ПТ', 'ПТ'), ('СБ', 'СБ')], max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_type', models.CharField(choices=[('I+', 'I+'), ('I-', 'I-'), ('II+', 'II+'), ('II-', 'II-'), ('III+', 'III+'), ('III-', 'III-'), ('IV+', 'IV+'), ('IV-', 'IV-')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('запланировано', 'запланировано'), ('завершено', 'завершено'), ('отменено', 'отменено')], max_length=50)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.patient')),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_app.doctor')),
            ],
        ),
